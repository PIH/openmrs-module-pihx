...
public class DataChangeInterceptor extends EmptyInterceptor {
	...
	private void addChange(OpenmrsObject object, String[] propertyNames, Type[] types, Object[] beforeState, Object[] afterState, DataChangeType changeType) {
        ...
        if (propertyNames != null && types != null) {
            for (int i=0; i<propertyNames.length; i++) {
                Object before = beforeState == null ? null : normalizeValue(beforeState[i]);
                Object after = afterState == null ? null : normalizeValue(afterState[i]);
    ...
    private Object normalizeValue(Object o) {
		...
		if (o instanceof Date) {
			...
			return null; // Do not operate on Collection properties, these are handled as separate Change Elements
		}
		return o;
    }
